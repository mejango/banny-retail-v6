...
contract AirdropV4BannysOptimism {
    address[] private transferOwners;

    constructor(address[] memory _transferOwners) {
        require(_transferOwners.length == 6, "Transfer owner count mismatch");
        transferOwners = _transferOwners;
    }


    function requireMintedTokenIds(uint256[] calldata mintedTokenIds) external pure {
        require(mintedTokenIds.length == 11, "Minted token count mismatch");
        ...
        require(mintedTokenIds[4] == 4000000003, "Minted token ID mismatch");
        require(mintedTokenIds[5] == 11000000001, "Minted token ID mismatch");
        require(mintedTokenIds[6] == 17000000001, "Minted token ID mismatch");
        require(mintedTokenIds[7] == 19000000001, "Minted token ID mismatch");
        require(mintedTokenIds[8] == 25000000001, "Minted token ID mismatch");
        require(mintedTokenIds[9] == 44000000001, "Minted token ID mismatch");
        require(mintedTokenIds[10] == 47000000001, "Minted token ID mismatch");
    }
    ...
    function executeMigration(
...

        {
            ...
            outfitIds[3] = 44000000001; // V4 44000000001
...

        {
            ...
            outfitIds[0] = 47000000001; // V4 47000000001
        ...
        targetTokenIds[4] = 4000000003; // V4 4000000003
        targetTokenIds[5] = 17000000001; // V4 17000000001
        ...
        v4TokenIds[4] = 4000000003; // V4 4000000003
        v4TokenIds[5] = 17000000001; // V4 17000000001
        ...
        require(successfulTransfers == 6, "Not all items were transferred");
